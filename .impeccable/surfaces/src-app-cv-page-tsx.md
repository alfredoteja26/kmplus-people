---
version: 1
slug: "src-app-cv-page-tsx"
primary_target: "src/app/cv/page.tsx"
related_targets: ["src/app/people/page.tsx"]
---
...
**THESIS:** Field-by-field HR skepticism is the product—not upload heroics or dashboard symmetry. Refuses metric cards, symmetric KPI grids, and auto-trust of parser output.

**OWN-WORLD:** KMPlus Operate on `#FAFAFA`: paper cards, 1.5px `--line`, sage `#1E857C` primaries, tint wash on selected queue rows and field blocks, faint uppercase captions, pill StatusBadges, Inter throughout.

**STORY:** HR believes every proposed value is provisional until Accept, Edit, or Reject; Apply writes only reviewed fields to new hire or existing Person without silent legal identity overwrite. Employees see applied evidence read-only.

**FIRST VIEWPORT:** PageHeader kicker plus title; compact HR upload strip (not hero); two-pane grid—left scrollable document queue with state badges, right review panel with stacked field rows and tri-action footer when unlocked.

**FORM:** Operate review desk (two-pane queue + inspector), chosen over single-column wizard or modal upload; seed: `cv-review-operate-desk`.

**FINISH:** unreviewed and undocumented is unfinished; this build ends with the finish review, the verdict, DESIGN.md, and every shipping raster carrying its provenance.

**Route:** Ship at `/cv` per builder lock; People local nav may link here without relocating the route to `/people/cv` in this craft pass.
